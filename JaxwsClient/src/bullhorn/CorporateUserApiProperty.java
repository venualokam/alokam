...
/**
 * <p>Java class for corporateUserApiProperty.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="corporateUserApiProperty">
 *   &lt;restriction base="{http://www.w3.org/2001/XMLSchema}string">
 *     &lt;enumeration value="userID"/>
 *     &lt;enumeration value="corporationID"/>
 *     &lt;enumeration value="emailNotify"/>
 *     &lt;enumeration value="emailSignature"/>
 *     &lt;enumeration value="enabled"/>
 *     &lt;enumeration value="externalEmail"/>
 *     &lt;enumeration value="inboundEmailEnabled"/>
 *     &lt;enumeration value="isOutboundFaxEnabled"/>
 *     &lt;enumeration value="primaryPrivateLabelID"/>
 ...
 * 
 */
@XmlType(name = "corporateUserApiProperty", namespace = "http://user.entity.bullhorn.com/")
@XmlEnum
public enum CorporateUserApiProperty {

    @XmlEnumValue("userID")
    USER_ID("userID"),
    @XmlEnumValue("corporationID")
    CORPORATION_ID("corporationID"),
    @XmlEnumValue("emailNotify")
    EMAIL_NOTIFY("emailNotify"),
    @XmlEnumValue("emailSignature")
    EMAIL_SIGNATURE("emailSignature"),
    @XmlEnumValue("enabled")
    ENABLED("enabled"),
    @XmlEnumValue("externalEmail")
    EXTERNAL_EMAIL("externalEmail"),
    @XmlEnumValue("inboundEmailEnabled")
    INBOUND_EMAIL_ENABLED("inboundEmailEnabled"),
    @XmlEnumValue("isOutboundFaxEnabled")
    IS_OUTBOUND_FAX_ENABLED("isOutboundFaxEnabled"),
    @XmlEnumValue("primaryPrivateLabelID")
    PRIMARY_PRIVATE_LABEL_ID("primaryPrivateLabelID"),
    ...
    CorporateUserApiProperty(String v) {
        value = v;
    }
    ...
    public static CorporateUserApiProperty fromValue(String v) {
        for (CorporateUserApiProperty c: CorporateUserApiProperty.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
