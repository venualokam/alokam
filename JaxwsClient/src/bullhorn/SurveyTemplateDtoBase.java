...
/**
 * <p>Java class for surveyTemplateDtoBase complex type.
 * 
 ...
 *         &lt;element name="surveyTemplateID" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/>
...
@XmlType(name = "surveyTemplateDtoBase", namespace = "http://survey.entity.bullhorn.com/", propOrder = {
    "dateAdded",
    "description",
    "migrateGUID",
    "name",
...
@XmlSeeAlso({
    SurveyTemplateDto.class
})
public abstract class SurveyTemplateDtoBase
    extends AbstractDto
{
    ...
    protected Integer surveyTemplateID;
     ...
     *     
     */
    public void setSurveyTemplateID(Integer value) {
        this.surveyTemplateID = value;
    }
