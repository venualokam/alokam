 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://webservice", wsdlLocation = "http://localhost:7001/webservicews/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://webservice", "HelloWorldService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:7001/webservicews/HelloWorld?wsdl");
     ...
     *     returns HelloWorld
     */
    @WebEndpoint(name = "HelloWorldSoapPort")
    public HelloWorld getHelloWorldSoapPort() {
        return super.getPort(new QName("http://webservice", "HelloWorldSoapPort"), HelloWorld.class);
    }
     ...
     */
    @WebEndpoint(name = "HelloWorldSoapPort")
    public HelloWorld getHelloWorldSoapPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice", "HelloWorldSoapPort"), HelloWorld.class, features);
    }
