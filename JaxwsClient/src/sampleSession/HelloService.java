 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://server.session/", wsdlLocation = "https://localhost:8443/test/services/Hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://server.session/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://localhost:8443/test/services/Hello?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://server.session/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.session/", "HelloPort"), Hello.class, features);
    }
