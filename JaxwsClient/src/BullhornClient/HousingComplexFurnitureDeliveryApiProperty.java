...
/**
 * <p>Java class for housingComplexFurnitureDeliveryApiProperty.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="housingComplexFurnitureDeliveryApiProperty">
 *   &lt;restriction base="{http://www.w3.org/2001/XMLSchema}string">
 *     &lt;enumeration value="housingComplexFurnitureDeliveryID"/>
 ...
 *     &lt;enumeration value="dateOfDelivery"/>
 *     &lt;enumeration value="dateOfOrder"/>
 *     &lt;enumeration value="dateOfPickup"/>
 ...
 * 
 */
@XmlType(name = "housingComplexFurnitureDeliveryApiProperty", namespace = "http://housing.entity.bullhorn.com/")
@XmlEnum
public enum HousingComplexFurnitureDeliveryApiProperty {

    @XmlEnumValue("housingComplexFurnitureDeliveryID")
    HOUSING_COMPLEX_FURNITURE_DELIVERY_ID("housingComplexFurnitureDeliveryID"),
    ...
    HousingComplexFurnitureDeliveryApiProperty(String v) {
        value = v;
    }
    ...
    public static HousingComplexFurnitureDeliveryApiProperty fromValue(String v) {
        for (HousingComplexFurnitureDeliveryApiProperty c: HousingComplexFurnitureDeliveryApiProperty.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
