...
/**
 * <p>Java class for placementApiProperty.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="placementApiProperty">
 *   &lt;restriction base="{http://www.w3.org/2001/XMLSchema}string">
 *     &lt;enumeration value="placementID"/>
 *     &lt;enumeration value="approvingClientContactID"/>
 *     &lt;enumeration value="backupApprovingClientContactID"/>
 ...
 *     &lt;enumeration value="invoiceGroupName"/>
 ...
 *     &lt;enumeration value="reportedMargin"/>
 ...
 * 
 */
@XmlType(name = "placementApiProperty", namespace = "http://job.entity.bullhorn.com/")
@XmlEnum
public enum PlacementApiProperty {

    @XmlEnumValue("placementID")
    PLACEMENT_ID("placementID"),
    @XmlEnumValue("approvingClientContactID")
    APPROVING_CLIENT_CONTACT_ID("approvingClientContactID"),
    @XmlEnumValue("backupApprovingClientContactID")
    BACKUP_APPROVING_CLIENT_CONTACT_ID("backupApprovingClientContactID"),
    ...
    @XmlEnumValue("invoiceGroupName")
    INVOICE_GROUP_NAME("invoiceGroupName"),
    ...
    public static PlacementApiProperty fromValue(String v) {
        for (PlacementApiProperty c: PlacementApiProperty.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
