 ...
 * 
 */
@WebServiceClient(name = "ScoreUploadingService", targetNamespace = "http://webtest.skillcheck.com", wsdlLocation = "file:/D:/Personal/JaxwsSample1/web/WEB-INF/wsdl/ScoreUploadingService.wsdl")
    ...
    extends Service
{
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/Personal/JaxwsSample1/web/WEB-INF/wsdl/ScoreUploadingService.wsdl");
