...
/**
 * <p>Java class for workersCompensationDtoBase complex type.
 * 
...
@XmlType(name = "workersCompensationDtoBase", namespace = "http://job.entity.bullhorn.com/", propOrder = {
    "code",
    "description",
    "name",
    "state",
...
@XmlSeeAlso({
    WorkersCompensationDto.class
})
public abstract class WorkersCompensationDtoBase
    extends AbstractDto
{
    ...
    protected Integer workersCompensationID;
     ...
     *     
     */
    public void setWorkersCompensationID(Integer value) {
