    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(bullhorn.ApiService_Service.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = bullhorn.ApiService_Service.class.getResource(".");
            url = new URL(baseUrl, "https://api.bullhornstaffing.com/webservices-1.1/?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'https://api.bullhornstaffing.com/webservices-1.1/?wsdl', retrying as a local file");
