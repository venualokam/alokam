...
/**
 * <p>Java class for distributionListDtoBase complex type.
 * 
...
@XmlType(name = "distributionListDtoBase", namespace = "http://distlist.entity.bullhorn.com/", propOrder = {
    "dateAdded",
    "description",
    "distributionListID",
    "groupName",
...
@XmlSeeAlso({
    DistributionListDto.class
})
public abstract class DistributionListDtoBase
    extends AbstractDto
{
    ...
    protected Integer distributionListID;
     ...
     *     
     */
    public void setDistributionListID(Integer value) {
        this.distributionListID = value;
    }
