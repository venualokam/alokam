...
/**
 * <p>Java class for dtoQuery complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="dtoQuery">
 *   &lt;complexContent>
 ...
 *         &lt;element name="orderBys" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "dtoQuery", namespace = "http://query.apiservice.bullhorn.com/", propOrder = {
    "alias",
    "entityName",
    "maxResults",
    "orderBys",
...
public class DtoQuery {
    ...
    public static class Parameters {
        ...
        protected List<DtoQuery.Parameters.Entry> entry;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link DtoQuery.Parameters.Entry }
         * 
         * 
         */
        public List<DtoQuery.Parameters.Entry> getEntry() {
            if (entry == null) {
                entry = new ArrayList<DtoQuery.Parameters.Entry>();
            }
            return this.entry;
        }
